...
class Chain {
    ...
    constructor() {
        this.chain = [new Block('', new Transaction("", 'genesis', 'godwin'))];
    }
    ...
    addBlock(transaction: Transaction, senderPublicKey: string, signature: Buffer) {
        ...
        console.log("🎫 Sending ChatBuckCoin...")
...
class Wallet {
    ...
    sendMessage(amount: string, payeePublicKey: string) {
...
let message1 = "hi"
// let me = message1.split("");
// for(const i of me) {
//     console.log(i.charCodeAt(0));
//     // console.log(i);
//     // agp.sendMessage(i.charCodeAt(0), jz.publicKey);
...
let message2 = "Lets rock the world"



agp.sendMessage(message1, jz.publicKey);
jz.sendMessage(message2, jb.publicKey);
// jb.sendMessage(5, jz.publicKey);
